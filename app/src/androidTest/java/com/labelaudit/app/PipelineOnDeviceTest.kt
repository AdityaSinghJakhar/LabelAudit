...
class PipelineOnDeviceTest {
    ...
    fun extractedMrpAndQuantityNormaliseToTheExpectedValues() {
        ...
        assertEquals(
            45.0,
            com.labelaudit.app.pipeline.Normalize.money(fields["mrp"]!!.value)!!,
            0.001
        )
        assertEquals(
            Pair(500.0, "g"),
            com.labelaudit.app.pipeline.Normalize.quantity(fields["net_quantity"]!!.value)
        )
    }
    ...
    fun aMinorityMisreadIsDiscardedByConsensus() {
        ...
        assertEquals(
            45.0,
            com.labelaudit.app.pipeline.Normalize.money(mrp!!.value)!!,
            0.001
        )
